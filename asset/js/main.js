...
$(document).on('click', '#tombolPopup', function (e) {
    ...
    Swal.fire({
        icon: 'info',
        title: 'Assalamualaikum Ukhti',
        text: 'Aku ada pertanyaan nih buat kamu yang manis ^_^',
        showClass: {
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                Swal.fire({
                    title: 'Kenalin nih aku Jati panggil aja Bee canda Bee :v, kalo kamu mau di panggil apa :)',
                    showClass: {
                        popup: 'animate__animated animate__jackInTheBox'
                    },
                    hideClass: {
                    ...
                    function () {
                        ...
                        console.log(nama);
                        Swal.fire({
                            title: nama + ' ' + 'kangen aku ga ?',
                            icon: 'question',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                            confirmButtonText: 'kangen sih',
                            cancelButtonText: 'dih siapa kamu',
                            showClass: {
                                popup: 'animate__animated animate__jackInTheBox'
                            },
                            hideClass: {
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'Sama aku juga kangen sama kamu' + ' ' + nama ,
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Terima kasih sudah kangen ke aku' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Sekarang' + ' ' + nama + ' ' + 'sayang sama aku gak?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    title: 'Tapi aku sayang banget sama ' + ' ' + nama,
                                                    icon: 'info',
                                                    showClass: {
                                                        popup: 'animate__animated animate__jackInTheBox'
                                                    },
                                ...
                                Swal.fire({
                                    title: 'Beneran? Aku tanya sekali lagi nih. Kangen gak sama aku?',
                                    icon: 'question',
                                    text: 'Coba jawab yang bener',
                                    showCancelButton: true,
                                    confirmButtonText: 'Beneran, enggak',
                                    cancelButtonText: 'Ya, kangen lah',
